...
// Accept all image types, as the browser will attempt to read them.
// Server-side processing will handle failures gracefully.
export const ALL_IMAGE_FORMATS: Accept = {
  'image/*': [],
};
