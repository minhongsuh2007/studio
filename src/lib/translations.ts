...
export const translations: Translations = {
  en: {
    ...
    starPatternOverwrittenToastDesc: "Existing pattern updated. New pattern & characteristics from '{fileName}' ({starCount} stars; AvgBr: {avgBrightness}, AvgCo: {avgContrast}, AvgFw: {avgFwhm}) captured. Stored locally.",
    ...
    activePatternTitle: "Active Learned Pattern:",
    ...
    learningModeCardDescription: "Activate to manually teach the system a reference star pattern for improved alignment. Patterns are stored in your browser.",
    allLearnedPatternsListTitle: "Stored Patterns",
    setActiveButtonText: "Set Active",
    ...
    activePatternSetToastTitle: "Active Pattern Set",
    ...
    noActivePatternSelectedInfo: "No pattern is currently active. Select one from the list below or learn a new one.",

    learnTestCardTitle: "Learn Test Module",
    learnTestCardDescription: "Upload an image here to see which stars are recognized based on the *active* learned pattern's characteristics.",
    ...
    noActivePatternForTestToastTitle: "No Active Pattern",
    noActivePatternForTestToastDesc: "Please set an active learned pattern before running a test.",
    ...
    testAnalysisCompleteToastDesc: "{count} stars on '{fileName}' matched the active learned pattern.",
    testAnalysisNoStarsFoundToastDesc: "No stars on '{fileName}' matched the active learned pattern well enough.",
  ...
  ko: {
    ...
    starPatternOverwrittenToastDesc: "기존 패턴 업데이트됨. '{fileName}' ({starCount}개 별; 평균밝기: {avgBrightness}, 평균대비: {avgContrast}, 평균FWHM: {avgFwhm})의 새 패턴 및 특성 캡처됨. 로컬에 저장됩니다.",
    ...
    activePatternSetToastDesc: "'{fileName}'의 패턴이 이제 활성 참조입니다.",
    allPatternsClearedToastTitle: "모든 패턴 지워짐",
    allPatternsClearedToastDesc: "모든 학습된 별 패턴이 로컬 저장소에서 제거되었습니다.",
    noActivePatternSelectedInfo: "현재 활성화된 패턴이 없습니다. 아래 목록에서 선택하거나 새 패턴을 학습하세요.",

    learnTestCardTitle: "학습 테스트 모듈",
    learnTestCardDescription: "여기에 이미지를 업로드하여 *활성* 학습 패턴의 특성을 기반으로 어떤 별이 인식되는지 확인하세요.",
    uploadTestImageButton: "테스트 이미지 업로드",
    runPatternTestButton: "패턴 테스트 실행",
    analyzingTestImageProgress: "학습된 패턴으로 테스트 이미지 분석 중...",
    noActivePatternForTestToastTitle: "활성 패턴 없음",
    noActivePatternForTestToastDesc: "테스트를 실행하기 전에 활성 학습 패턴을 설정하세요.",
    noTestImageToastTitle: "테스트 이미지 없음",
    noTestImageToastDesc: "학습된 패턴을 테스트할 이미지를 업로드하세요.",
    testAnalysisCompleteToastTitle: "학습 테스트 완료",
    testAnalysisCompleteToastDesc: "'{fileName}'의 별 {count}개가 활성 학습 패턴과 일치했습니다.",
    testAnalysisNoStarsFoundToastDesc: "'{fileName}'의 별 중 활성 학습 패턴과 충분히 일치하는 별이 없습니다.",
  ...
  zh: {
    ...
    starPatternOverwrittenToastDesc: "现有图案已更新。已捕获来自“{fileName}”({starCount}颗星；平均亮度: {avgBrightness}, 平均对比度: {avgContrast}, 平均FWHM: {avgFwhm})的新图案和特征。本地存储。",
    ...
    activePatternSetToastDesc: "来自“{fileName}”的图案现在是活动参考。",
    allPatternsClearedToastTitle: "所有图案已清除",
    allPatternsClearedToastDesc: "所有学习的星点图案已从本地存储中移除。",
    noActivePatternSelectedInfo: "当前没有活动的图案。请从下面的列表中选择一个或学习一个新的图案。",

    learnTestCardTitle: "学习测试模块",
    learnTestCardDescription: "在此上传图像，以查看基于*活动*学习图案的特征识别出哪些星点。",
    uploadTestImageButton: "上传测试图像",
    runPatternTestButton: "运行图案测试",
    analyzingTestImageProgress: "正在使用学习图案分析测试图像...",
    noActivePatternForTestToastTitle: "无活动图案",
    noActivePatternForTestToastDesc: "运行测试前，请设置一个活动的学习图案。",
    noTestImageToastTitle: "无测试图像",
    noTestImageToastDesc: "请上传图像以测试学习的图案。",
    testAnalysisCompleteToastTitle: "学习测试完成",
    testAnalysisCompleteToastDesc: "图像“{fileName}”上的 {count} 颗星与活动学习图案匹配。",
    testAnalysisNoStarsFoundToastDesc: "图像“{fileName}”上没有足够匹配活动学习图案的星点。",
