...
export const translations: Translations = {
  ...
  de: {
    appTitle: 'AstroStacker',
    uploadAndConfigure: 'Bilder hochladen & konfigurieren',
    cardDescription: "Fügen Sie Ihre Light-Frames (PNG, JPG, TIFF, FITS usw.) hinzu. Die App versucht, jedes Dateiformat zu konvertieren. Bilder werden anhand von Sternmustern ausgerichtet. Für beste Ergebnisse mit der 'Standard'-Methode wählen Sie die Referenzsterne auf dem ersten Bild manuell aus.",
    creditsLine1: 'AstroStacker © {year}',
    creditsLine2Part1: 'Erstellt von Min Hong Seo (암흑광자) mit unschätzbarer Hilfe von 천관사, Saturn, 구구, Flec, Latte, 얼음세상, 뉴비, 오르트, 지민, 모닥별, 배추빙수, 응애, Kangwoo, Won Taeho und vielen anderen.',
    switchToEnglish: 'EN',
    switchToKorean: 'KO',
    switchToChinese: 'ZH',
    switchToJapanese: 'JA',
    switchToGerman: 'DE',
    stackImagesButton: 'Bilder stapeln ({count})',
    stackingButtonInProgress: 'Stapeln...',
    finalizeAndDownload: 'Bild fertigstellen & herunterladen',
    imageQueueCount: 'Bilder-Warteschlange ({count})',
    stackingMode: 'Stapelmodus',
    previewFit: 'Vorschau-Anpassung',
    fitContain: 'Einpassen',
    fitCover: 'Ausfüllen',
    outputFormat: 'Ausgabeformat',
    jpgQuality: 'JPG-Qualität: {jpegQuality}%',
    editStarsFor: 'Sterne bearbeiten für: {fileName}',
    editStarsDescription: 'Klicken Sie auf Sterne, um sie hinzuzufügen/zu entfernen. Aktuell: {starCount} Sterne. Bildgröße: {width}x{height}.',
    resetToAuto: 'Automatisch zurücksetzen',
    wipeAllStars: 'Alle Sterne löschen',
    confirmAndClose: 'Bestätigen & Schließen',
    confirmAndNext: 'Bestätigen & Weiter',
    cancelEditing: 'Bearbeitung abbrechen',
    processingLogs: 'Verarbeitungsprotokolle',
    applyStarOptionsMenuTitle: 'Sternauswahl auf andere anwenden',
    applyStarOptionsMenuDesc: "Sie haben {starCount} Sterne für '{fileName}' ({width}x{height}px) festgelegt. Wie möchten Sie diese Auswahl auf andere Bilder in der Warteschlange anwenden?",
    applyToMatchingDimensionsBtn: 'Auf {count} Bilder mit passenden Maßen anwenden',
    applyProportionallyBtn: 'Proportional auf {count} Bilder mit ähnlichem Seitenverhältnis anwenden',
    dontApplyToOthersBtn: 'Nicht auf andere anwenden',
    toastStarsAppliedMatchingDimTitle: "Sterne angewendet (Passende Maße)",
    toastStarsAppliedMatchingDimDesc: "Die ausgewählten Sterne wurden auf andere Bilder mit passenden Maßen angewendet.",
    toastProportionalApplySkippedTitle: "Proportionale Anwendung übersprungen",
    toastProportionalApplySkippedDesc: "Quellbild '{fileName}' hat keine ausgewählten Sterne. Proportionale Anwendung übersprungen.",
    toastProportionalApplyDoneTitle: "Sterne angewendet (proportional)",
    toastProportionalApplyDoneDesc: "Sterne wurden proportional auf Bilder mit passendem Seitenverhältnis angewendet.",
    downscalePrompt: "Bild '{fileName}' ({width}x{height}px) ist groß. Eine Skalierung auf max. {maxSize}px (Seitenverhältnis beibehalten) kann Stabilität und Geschwindigkeit verbessern. Skalieren?",
    stackingProgress: 'Stapeln: {progressPercent}%',
    darkFramesUploadTitle: 'Dark-Frames (Optional)',
    darkFramesUploadDescription: 'Laden Sie einen oder mehrere Dark-Frames (JPG/PNG/WEBP/FITS) hoch. Sie werden zu einem Master-Dark gemittelt und dann von jedem Light-Frame abgezogen, um thermisches Rauschen zu reduzieren. Achten Sie auf ähnliche Abmessungen.',
    useDarkFramesLabel: 'Dark-Frame-Subtraktion aktivieren',
    darkFramesPreviewTitle: 'Dark-Frame-Vorschau ({count})',
    darkFramesMissing: "Dark-Frame-Subtraktion aktiviert, aber keine Darks hochgeladen oder Ladefehler.",
    darkFramesMissingTitle: "Dark-Frames fehlen",
    logLoadingDarkFrames: "Lade {count} Dark-Frame(s)...",
    logMasterDarkCreated: "Master-Dark-Frame aus {count} Frames erstellt.",
    logMasterDarkFailed: "Master-Dark-Frame konnte nicht erstellt werden (keine gültigen Darks).",
    logBiasSubtractedFromDark: "Bias (falls vorhanden) von Dark-Frame abgezogen: {darkFrameName}",
    flatFramesUploadTitle: 'Flat-Frames (Optional)',
    flatFramesUploadDescription: 'Laden Sie einen oder mehrere Flat-Frames (JPG/PNG/WEBP/FITS) hoch. Sie werden zu einem Master-Flat gemittelt und zur Korrektur von Sensorstaub, Vignettierung usw. verwendet. Achten Sie auf ähnliche Abmessungen.',
    useFlatFramesLabel: 'Flat-Field-Korrektur aktivieren',
    flatFramesPreviewTitle: 'Flat-Frame-Vorschau ({count})',
    flatFramesMissing: "Flat-Field-Korrektur aktiviert, aber keine Flats hochgeladen oder Ladefehler.",
    flatFramesMissingTitle: "Flat-Frames fehlen",
    logLoadingFlatFrames: "Lade {count} Flat-Frame(s)...",
    logMasterFlatCreated: "Master-Flat-Frame aus {count} Frames erstellt.",
    logMasterFlatFailed: "Master-Flat-Frame konnte nicht erstellt werden (keine gültigen Flats).",
    logBiasSubtractedFromFlat: "Flat-Frame, von dem Bias (falls vorhanden) abgezogen wurde: {flatFrameName}",
    biasFramesUploadTitle: 'Bias-Frames (Optional)',
    biasFramesUploadDescription: 'Laden Sie einen oder mehrere Bias-Frames (JPG/PNG/WEBP/FITS) hoch. Sie werden zu einem Master-Bias gemittelt, das das Ausleserauschen der Kamera darstellt. Wird von Light-, Dark- und Flat-Frames abgezogen, falls verwendet. Achten Sie auf ähnliche Abmessungen.',
    useBiasFramesLabel: 'Bias-Frame-Subtraktion aktivieren',
    biasFramesPreviewTitle: 'Bias-Frame-Vorschau ({count})',
    biasFramesMissing: "Bias-Frame-Subtraktion aktiviert, aber keine Bias-Frames hochgeladen oder Ladefehler.",
    biasFramesMissingTitle: "Bias-Frames fehlen",
    logLoadingBiasFrames: "Lade {count} Bias-Frame(s)...",
    logMasterBiasCreated: "Master-Bias-Frame aus {count} Frames erstellt.",
    logMasterBiasFailed: "Master-Bias-Frame konnte nicht erstellt werden (keine gültigen Biases).",
    logDarkFrameLoaded: "Dark-Frame {fileName} geladen ({width}x{height}).",
    logFlatFrameLoaded: "Flat-Frame {fileName} geladen ({width}x{height}).",
    logBiasFrameLoaded: "Bias-Frame {fileName} geladen ({width}x{height}).",
    startLearningSession: "Lernsitzung starten",
    stopLearningSession: "Lernsitzung beenden",
    learningModeActiveIndicator: "LERNMODUS AKTIV",
    enterPinDialogTitle: "PIN eingeben, um den Lernmodus zu aktivieren",
    enterPinDialogDesc: "Geben Sie die vorgesehene PIN ein, um eine Lernsitzung zu starten. Dies ermöglicht es Ihnen, Referenzsternmuster zu definieren.",
    pinPlaceholder: "PIN-Code",
    submitPinButton: "PIN senden",
    incorrectPinToastTitle: "Falsche PIN",
    incorrectPinToastDesc: "Die eingegebene PIN ist falsch. Lernmodus nicht aktiviert.",
    learningModeActivatedToastTitle: "Lernmodus aktiviert",
    learningModeActivatedToastDesc: "Sie können jetzt Sternmuster definieren, indem Sie Sterne auf einem Bild bearbeiten und bestätigen. Wählen Sie Muster aus der Liste aus, um sie für das Stapeln oder Testen zu verwenden.",
    learningModeDeactivatedToastTitle: "Lernmodus deaktiviert",
    learningModeDeactivatedToastDesc: "Die aktuelle Lernsitzung wurde beendet. Gelernte Muster bleiben lokal gespeichert.",
    starPatternFirstLearnedToastTitle: "Sternmuster gelernt!",
    starPatternFirstLearnedToastDesc: "Muster & Eigenschaften von '{fileName}' ({starCount} Sterne; AvgBr: {avgBrightness}, AvgCo: {avgContrast}, AvgFw: {avgFwhm}) erfasst. Es wurde Ihrer Liste hinzugefügt und lokal gespeichert.",
    starPatternOverwrittenToastTitle: "Gelerntes Sternmuster aktualisiert!",
    starPatternOverwrittenToastDesc: "Bestehendes Muster für '{fileName}' aktualisiert. Neues Muster & Eigenschaften ({starCount} Sterne; AvgBr: {avgBrightness}, AvgCo: {avgContrast}, AvgFw: {avgFwhm}) erfasst. Lokal gespeichert.",
    noPatternLearnedYetInfo: "Es wurde noch kein Sternmuster gelernt. Bearbeiten Sie Sterne auf einem Bild und bestätigen Sie, um eines zu erstellen.",
    patternStoredButModeOffInfo: "{count} Muster lokal gespeichert. Aktivieren Sie den Lernmodus, um sie zu verwenden oder zu verwalten.",
    selectedPatternsTitle: "Ausgewählte Muster zum Stapeln ({count})",
    avgBrightnessLabel: "Durchschn. Helligkeit",
    avgContrastLabel: "Durchschn. Kontrast",
    avgFwhmLabel: "Durchschn. FWHM",
    learningModeCardTitle: "Musterlernen & Datenmanagement",
    learningModeCardDescription: "Bringen Sie der KI manuell Sternmuster bei, um die Ausrichtung zu verbessern. Sie können Ihre gelernten Muster auch zur Sicherung oder zum Teilen in eine Datei exportieren und Muster aus einer Datei importieren.",
    allLearnedPatternsListTitle: "Gespeicherte Muster",
    selectPatternCheckboxLabel: "Muster aus {fileName} zum Stapeln/Testen auswählen",
    deletePatternButtonText: "Löschen",
    clearAllLearnedPatternsButton: "ALLE gelernten Muster löschen",
    patternDeletedToastTitle: "Muster gelöscht",
    patternDeletedToastDesc: "Muster von '{fileName}' wurde gelöscht.",
    allPatternsClearedToastTitle: "Alle Muster gelöscht",
    allPatternsClearedToastDesc: "Alle gelernten Sternmuster wurden aus dem lokalen Speicher entfernt.",
    noActivePatternSelectedInfo: "Derzeit sind keine Muster ausgewählt. Aktivieren Sie die Kontrollkästchen in der Liste unten, um Muster für die Ausrichtungshilfe oder zum Testen auszuwählen.",
    learnedDateLabel: "Gelernt: {date}",
    learnTestCardTitle: "Lerntestmodul",
    learnTestCardDescription: "Laden Sie hier ein Bild hoch, um zu sehen, welche Sterne basierend auf dem trainierten KI-Modell erkannt werden.",
    uploadTestImageButton: "Testbild hochladen",
    runPatternTestButton: "Mustertest durchführen",
    analyzingTestImageProgress: "Analysiere Testbild mit KI-Modell...",
    noActivePatternForTestToastTitle: "Kein Muster für den Test ausgewählt",
    noActivePatternForTestToastDesc: "Bitte wählen Sie genau ein gelerntes Muster aus der obigen Liste aus, um einen Test durchzuführen.",
    learnTestSelectSinglePatternTitle: "Wählen Sie ein Muster für den Test aus",
    learnTestSelectSinglePatternDesc: "Bitte wählen Sie genau ein Muster aus der Liste 'Gespeicherte Muster' für diesen Test aus.",
    noTestImageToastTitle: "Kein Testbild",
    noTestImageToastDesc: "Bitte laden Sie ein Bild hoch, um das gelernte Muster daran zu testen.",
    testAnalysisCompleteToastTitle: "Lerntest abgeschlossen",
    testAnalysisCompleteToastDesc: "{count} Sterne auf '{fileName}' stimmten mit dem ausgewählten gelernten Muster überein.",
    testAnalysisNoStarsFoundToastDesc: "Keine Sterne auf '{fileName}' stimmten gut genug mit dem ausgewählten gelernten Muster überein.",
    testImagePreviewTitle: "Testbild: {fileName}",
    recognizedStarsCount: "{count} Sterne vom Muster erkannt",
    tutorialButton: "Anleitung",
    tutorialTitle: "Wie man AstroStacker benutzt",
    tutorialStep1Title: "Schritt 1: Bilder hochladen",
    tutorialStep1Content: "Klicken Sie auf 'Bilder hierher ziehen' oder ziehen Sie Ihre Astrofotografie-Dateien in das Feld. Gängige Formate (JPG, PNG) und viele RAW-Formate (TIF, FITS usw.) werden dank ImageMagick unterstützt. Nach dem Hochladen analysiert die App automatisch jedes Bild, um Sterne zu erkennen.",
    tutorialStep2Title: "Schritt 2: Ausrichtungsmethode wählen",
    tutorialStep2Content: "Wählen Sie im linken Bereich Ihre 'Ausrichtungsmethode'.\n\n- Standard (2-Sterne): Diese klassische Methode verwendet die beiden hellsten Sterne in Ihrem ersten (REF) Bild, um alle anderen auszurichten. Es ist schnell und einfach. Für beste Ergebnisse können Sie auf 'Sterne auswählen' im Referenzbild klicken, um die beiden Ausrichtungssterne manuell auszuwählen.\n\n- KI-Muster: Diese leistungsstarke Methode verwendet ein maschinelles Lernmodell, um die besten Sterne für die Ausrichtung zu finden. Um es zu verwenden, müssen Sie zuerst die KI trainieren.",
    tutorialStep3Title: "Schritt 3: (KI-Methode) Die KI trainieren",
    tutorialStep3Content: "Um die 'KI-Muster'-Methode zu verwenden, müssen Sie zuerst Trainingsdaten erstellen und ein Modell trainieren.\n1. Klicken Sie auf einem analysierten Bild auf 'Sterne auswählen'.\n2. Klicken Sie in der Hauptvorschau auf mindestens 20-30 verschiedene, klare Sterne. Sie können dies über mehrere Bilder tun, indem Sie die Auswahl für jedes Bild bestätigen.\n3. Klicken Sie auf 'Bestätigen & Muster lernen'. Dies speichert die Eigenschaften Ihrer ausgewählten Sterne.\n4. Wählen Sie in der Karte 'Musterlernen' die Muster aus, die Sie für das Training verwenden möchten.\n5. Klicken Sie auf 'KI-Modell trainieren'. Dies trainiert ein Modell direkt in Ihrem Browser. Einmal trainiert, ist das Modell einsatzbereit und wird automatisch für zukünftige Sitzungen gespeichert.",
    tutorialStep4Title: "Schritt 4: Konfigurieren und Stapeln",
    tutorialStep4Content: "Unterhalb der Ausrichtungsmethode können Sie den 'Stapelmodus' (Durchschnitt, Median, Sigma-Clip) konfigurieren, der bestimmt, wie Pixelwerte kombiniert werden. Wenn Sie bereit sind, klicken Sie auf die Hauptschaltfläche 'Bilder stapeln'. Die App richtet jedes Bild aus und kombiniert sie dann, wobei der Fortschritt angezeigt wird.",
    tutorialStep5Title: "Schritt 5: Nachbearbeiten und Herunterladen",
    tutorialStep5Content: "Nach Abschluss des Stapelns wird das endgültige Bild angezeigt. Klicken Sie auf 'Bild fertigstellen & herunterladen', um den Nachbearbeitungseditor zu öffnen. Hier können Sie Helligkeit, Belichtung und Sättigung anpassen, um Ihr Bild zu verbessern. Wenn Sie zufrieden sind, klicken Sie auf die Schaltfläche 'Bild herunterladen', um das Ergebnis auf Ihrem Computer zu speichern.",
    exportPatternsButton: "Muster exportieren",
    importPatternsButton: "Muster importieren",
    importPatternsDropzone: "Musterdatei hier ablegen",
    noPatternsToExport: "Keine gelernten Muster zum Exportieren.",
    patternsImportedSuccess: "Import erfolgreich. {new} neue Muster hinzugefügt und {updated} bestehende aktualisiert.",
    patternImportFailed: "Musterimport fehlgeschlagen",
    trainModelButton: "KI-Modell trainieren",
    trainingModelButton: "Modell wird trainiert..."
  }
};
