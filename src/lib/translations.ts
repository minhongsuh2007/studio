...
export const translations: Translations = {
  en: {
    ...
    flatFrameUploadDescription: 'Upload a single flat frame (JPG/PNG). Used to correct for sensor dust, vignetting, and uneven illumination. Ensure similar dimensions to light frames.',
  ...
  ko: {
    ...
    darkFrameUploadDescription: '단일 다크 프레임(JPG/PNG)을 업로드하세요. 열 노이즈 감소를 위해 스태킹 전 각 라이트 프레임에서 빼게 됩니다. 최상의 결과를 위해 라이트 프레임과 유사한 크기인지 확인하세요.',
    ...
    flatFrameUploadDescription: '단일 플랫 프레임(JPG/PNG)을 업로드하세요. 센서 먼지, 비네팅, 고르지 않은 조명을 보정하는 데 사용됩니다. 라이트 프레임과 유사한 크기인지 확인하세요.',
    ...
    biasFrameUploadDescription: '단일 바이어스 프레임(JPG/PNG)을 업로드하세요. 카메라 읽기 노이즈를 나타내며, 사용 시 라이트, 다크, 플랫 프레임에서 차감됩니다. 유사한 크기인지 확인하세요.',
  ...
  zh: {
    ...
    darkFrameUploadDescription: '上传单个暗场文件 (JPG/PNG)。它将在叠加前从每个亮场中减去以减少热噪声。为获得最佳效果，请确保其尺寸与亮场相似。',
    ...
    biasFrameUploadDescription: '上传单个偏置场文件 (JPG/PNG)。代表相机的读出噪声，如果使用，将从亮场、暗场和平场中减去。确保尺寸相似。',
